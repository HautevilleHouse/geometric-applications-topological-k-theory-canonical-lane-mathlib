...
def mathlibProofObligation : MathlibProofObligation :=
  {
    sourceKey := "geometric-applications-topological-k-theory-canonical-lane",
    theoremObject := "Bott periodicity and index theorem",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedKTheoryClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_k_theory_endgame A
